...
public class GameMgr : MonoBehaviour
{
    ...
    public InputField trainingDate;
    ...
    public void Save()
    {
        ...
        PlayerPrefs.SetInt("Date", int.Parse(trainingDate.text));
    }
    public void Load()
    {
        if(PlayerPrefs.HasKey("Name")){
            ...
            inputWeight.text = PlayerPrefs.GetFloat("weight").ToString();
            trainingDate.text = PlayerPrefs.GetInt("Date").ToString();
        }
    }
}
